...
Integration test — requires the Java module's jars staged in ``core/java/jars/``
(see the README); skipped if absent.
"""
...
from datum.python.inventzia.pulse.data.datum.codec import from_tagged_json, to_tagged_json
